...
```sh
cd <beignet repo>   # sibling of ffor; use the revision in IMPLEMENTATION.md
./node_modules/.bin/ts-node -P ../ffor/tools/tsconfig.json \
  ../ffor/tools/generate-ffor-variant-d-vectors.ts > ../ffor/ffor-variant-d-vectors.md
```
...
entire file to stdout. See [IMPLEMENTATION.md](IMPLEMENTATION.md) for the pinned
reference revision and dependency setup. Output is deterministic: running it twice yields
byte-identical results.

---

*Generated by `tools/generate-ffor-variant-d-vectors.ts` against beignet
