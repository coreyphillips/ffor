...
`r_per_commitment_points` (`ff_init`, commitment numbers 43..43; only the first is used by the single voucher round):
...
**`ff_init` (type 55001, 218 bytes, signed by `R`)**

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `9bc4a29498b30e5e3e9fd346e7901f972b3b4e1669e2a9b878d9fedbfd9b6cae` |
| signature (final 64 bytes) | `23ff3f9d1e7723ec0edf3aea7743fd356911532307d45f58385b56371631d59e036a2b7d907f982e7e137dd08dadcb8210065e03ca20ed36b05e0dbb49eae3f0` |
| SHA256(wire bytes) | `672fd28f070af52d9cfabfa72f8c41e80ad0328eab8015c171c8fb3f8b8c926d` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_init` | `0cc44975f77c338c1b55f0570908aadbacc03413692fff3c88480b8240966279` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `f449bfb6c2357b56183993c33fdcba930b09568e67619abd646e70ceaee8504f` |
| signature (final 64 bytes) | `55ba10984e5e55fc54efbc56110953870881a3f43e755a773a495472b19e79b905522f0009ed2fb3f77a7f407e9a35b3bcc343613eb9b38790e4c6f666e73157` |
| SHA256(wire bytes) | `ac31fb1ca2d007ea039769c78f963efa68a1a88e649652daacec65f75578f4e8` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_setup` | `6410e40d18cc16a8f928a95dfe4daf63e9b66d7328c3d8c4aa7bb5d1139bbec8` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `f81f1fb4aee66f91b9824d31f3e16f057f0b917c02d914d45927833aab4a199a` |
| signature (final 64 bytes) | `1fe8c9b3503bef1965edc04e5e2b31714030f8fce38fcae01167edac2ff77f78402702eb819edaa0bdd60289526f7889a806e3cd12b2d102dbdeb72d27be4cdc` |
| SHA256(wire bytes) | `d69cc1159cc119808176f8e82c6186d07d67014e547c54c9985bdef37f725c53` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `H_act` | `3a4a3372a80e062cafe49c1349504f28cfb8a96f22065939aa978651ab8fc9b1` |

**`ff_activate_ack` (type 55047, 162 bytes, signed by `S`)** (`activation_hash = H_act`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `4dc55a860200d78fe67732444853a15c4e6deeb7b5c6a798bd87bb370d204d4e` |
| signature (final 64 bytes) | `bdf3e6b2ea9364365bea2dfccaf91893c1c8919a14336f0b217ec2bd17f25cf008d28686f2cdb608d5d32f274389e89434929566182d0949f0f349dba73f8301` |
| SHA256(wire bytes) | `6272857a85707e0ed8f4363e63f0c54a288f60fb7976a92ec30678ee2ea68414` |

Wire bytes:

```

```
...
`r_per_commitment_points` (`ff_init`, commitment numbers 43..45; only the first is used by the single voucher round):
...
**`ff_init` (type 55001, 300 bytes, signed by `R`)**

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `c3227ba04fbf7d269946c7f5142706f89104b61888c0414dc6f69e6247044b23` |
| signature (final 64 bytes) | `d3b19b5a9d09a96061a1e2b062a46f06294b9a21a2d3ce4217adbfc588da506f18780031da77ad296ef588493c12f4842687118ab44a9989066815b5c54177c6` |
| SHA256(wire bytes) | `a2e7339dde2424b398c054742401e7daf050a64310d5e25fbbbd382eafaa7766` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_init` | `dabae6bf6a89d8ef0f472ec84ea739d7b454503cf678dbe8895b920b52c7d5b0` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `176f164df53f115986d01225c331b919e1f65356c55d9ceadb1d60ebd243f547` |
| signature (final 64 bytes) | `efbfbb334b2dc9eb71fc00754760a0d8815efd8d356e016c241a5f0ba545bb537762bcfca6cd15721aa2b3f43a36087368c89abcaa04d34b60446371e03ae71e` |
| SHA256(wire bytes) | `48b803a75e28023ea80f0fc2119a609811459613cfbe86c3fdaa4f6adea304d6` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_setup` | `1bad4244b644567a1e5826191ab34f2835fe995eaa8a7e2c83c8155f1287720e` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `932b15da3bb2f1d318efea1967d5682fcfc61d7ae4a5270a0c5cc4c69963e0aa` |
| signature (final 64 bytes) | `b686f445658957270de1cd12cad887156022b1273eb37aed3a54c0ef26ed4cda6efc85ba71071df8b792b67e3a572d6479d9c3ee58cc5ece880c7b85552b0ad2` |
| SHA256(wire bytes) | `fd5b6368dfbe3ea893d77eedc03d120d792c05e004290ddc8a0535e2eeead9b7` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `H_act` | `9b228fbc9e66406cf20213f64002879f789a9e69e756cf34b07269b9b7904d4a` |

**`ff_activate_ack` (type 55047, 162 bytes, signed by `S`)** (`activation_hash = H_act`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `2f0ae867a786cb1751b1377735fd29e80fcf0b2f50bd22795872a13714687f0f` |
| signature (final 64 bytes) | `12425204a0a2d0bb78fa59a95a726f94df9eedc3f04eb1b426c62fdec5546ff55ec0e1b623ab8f9b651b506965b65b8b6dc828b63211d1c88e314406f78cb2a4` |
| SHA256(wire bytes) | `a679d76839301b873d6f49ac521eb2779030d32fa96966d4da2eaceb7222dfe4` |

Wire bytes:

```

```
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `11a5d47b6992aca79b7d2e2c29aa19d86f351269109f29b81b8cde99c8ea06d7` |
| signature (final 64 bytes) | `b647cf5417c82fc8e7ed8c813490f288433776571c814760fcec14fb9bda773a311601363f929e897d45d28be821ef3b3064d7be1739457c19b820f5135afee2` |
| SHA256(wire bytes) | `a60d13c0909bf1c0a27ea59b6f049404bfd1cd5f1442be753c48276c2bd0b723` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_init` | `e7431390ff1918e84a2f98d03f0648ad0cd74c9d26a5012a6b719bca31cb9daa` |

**`ff_accept` (type 55003, 306 bytes, signed by `S`)** (TLV 1 hashes, TLV 7 `s_htlc_id_base`, TLV 9 byte-identical to `ff_init`'s, TLV 11 = `T_init`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `eab3c79ca03ab5fcba7ccf4673e5a798207b21691e9122f0dc5e1d088bd715fd` |
| signature (final 64 bytes) | `a2659f8c1a6103eb6bce064c623bb4eeb3c1e36aea4208ce29c6d9459bc2a4570e2e9ae99776f08d5dfca90e87425e0cc921514a692bc678c9b69148d286dc28` |
| SHA256(wire bytes) | `a7ffb305cddd09c7e8b3808ef5b9c9a78e2ca09c8f748da3d8c672b79eae191d` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_setup` | `ee5fbe7080db14d8a2a2548df48f5877c69b66c2c9131550a711f4fefde3c9ff` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `1da194d123061887ed003f21bfcd3f8ec9d68b53621415e8ed5279879f406e67` |
| signature (final 64 bytes) | `58c4e340978814ba8f121a7575632d41066e8d5539e032c19bc14fc96b117ddc20a85dabbc0dfc8148c1a59fb63bac003ea62bb5089bbf947a8fa68083772034` |
| SHA256(wire bytes) | `caa118f756f6135300dd850eccd42fedbd11e9bc22e14d8dee8c0d80219d52ca` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `H_act` | `447b34f7d78364e0d35b85101803c1f0280763815ea7f1dd296418d80a46fa97` |

**`ff_activate_ack` (type 55047, 162 bytes, signed by `S`)** (`activation_hash = H_act`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `846c801efab81f4b12ff5739edf172cc54d3d5d4b460694e28a4dc02d60e0baf` |
| signature (final 64 bytes) | `a2385d47686cc9b2ebfab06dfded7be173dcf24ac5c634c4f18ee9727e8ed54577c491ba28d89855a370cc7812cfe2116a35b781b4a275b5642f5efd08742c3d` |
| SHA256(wire bytes) | `b5e65478b07b1a0d73eaf4bda3acfeac4d896a5f8bbe505d7b2b91a384124053` |

Wire bytes:

```

```
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `467e217fbf4ca96457531d0bd9b10cb31b35485adb51aebcbb2c53605c7a3224` |
| signature (final 64 bytes) | `777cf24d2f8df782c7a9c9b09f4a41095654a7a41650b68ea0cfcf08fa08e85d322ef78302e69516a9bda26860d161b8c92af40e5437d7b1a09dae6786871c0d` |
| SHA256(wire bytes) | `0d929ff2ebf5f3f8506c83b66181dde969eed3777dd1b75a7cd4a79c5f27a0dc` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_init` | `53f757d3a46b6c2f45945b8df2006ab6946179a0ee38c247bab11850de25958c` |

**`ff_accept` (type 55003, 226 bytes, signed by `S`)** (TLV 1 hashes, TLV 7 `s_htlc_id_base`, TLV 9 byte-identical to `ff_init`'s, TLV 11 = `T_init`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `e9fe6c3a7303581fa85f2acfd5c73656964603a63d273f044c4d544de16cd554` |
| signature (final 64 bytes) | `ed9dd0b01c4beee3f5c08c9c61a8e55d394277e3c2e037285ae9c741cf4e9bd4062fdb60831dacc109f164f09cd30099ab52e3e8591ff4f6d8899b6fbbf1081d` |
| SHA256(wire bytes) | `cd1d65fc41078aad0d8d0939d7070e0d68c5f67c7d7015425b101f1d2572fe31` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `T_setup` | `c1bfc381617d5482baeb109156e463261b2266163cabb06a27f9c47a90828176` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `20ed0a52178d1d9d391ca59915ef504fcad9a6c72b116e3f049af9f9d8e9e281` |
| signature (final 64 bytes) | `cb3c707d123367db1b4eca30c74d28fe85ccfb7ccc8c2516f571adeccf79e8684df043099ee433637dbf463ed30111dfb01e83651436822378e4989909d0e472` |
| SHA256(wire bytes) | `b8caff3aba943a9ebe6630a6eb4d015b674eb6b401d3c5698ccabc6fd5c9924b` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `H_act` | `b02975a29ca68cb33320fa5c4426626905cdc94c763a051984e652ee3f95a436` |

**`ff_activate_ack` (type 55047, 162 bytes, signed by `S`)** (`activation_hash = H_act`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `a33287787135ce72e659470c54bdbf91b62cd8c6eb3434b5e384b45918be4c87` |
| signature (final 64 bytes) | `2155d6393bd8aed1b1af3c1726e03b38d5db67f7d5c56fae637649b84fba3c4f75428aee4c64af410f0e61d703b5098a94884db3292f0edfb3ae7aa033081ee4` |
| SHA256(wire bytes) | `1e1b4f5d2ebbd836c63263cb67f76bc7508392109941a58a20e94bd0130ae52d` |

Wire bytes:

```

```
...
`r_per_commitment_points` carries 483 points for commitment numbers 43..525; the first is `03dcd6df1422406c9e57514174169f8219e69e77605ee0de483f5c3bac773d6a58` and the last is `034ef325327e8a3a2b465c21eb7c7a0b78ed6100a88c8cdd5186d77b7a81aa1ef1`.
...
**`ff_init` (type 55001, 19982 bytes, signed by `R`)**

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `04b96cd2ff186165bb5f435afc16b5ac1c295b8d0528e585f9c49ff3c2950bd5` |
| signature (final 64 bytes) | `57d88a2fd841c5a74782175e101a74af2f598f3543b2232f6d3e0155d14aefaf5032100c3dcc2a311dd5ff6799a2ffff2f2d003ab151b156b83be927e23b55a9` |
| SHA256(wire bytes) | `8c218eff016ddb5de9ede383beca28548dab8b1386f5161c262a5af91e112669` |

Wire bytes (first 160 bytes; the full 19982 bytes are reproduced by the generator):

```
...
```

| Field | Value |
|---|---|
| `T_init` | `4c578c1c8f1f5db85a3230ced42b8faf216edfdb79127f5e6be0509384b9c019` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `b7e247f86dd37e6c17bbbf1e93602bd80e8c546c519c0d4e71276c8deca5b39d` |
| signature (final 64 bytes) | `3a037a172c2ad37bbc4e88c1b948cf44ea111dbc240c31beec036f98cefc6287554a7bc210b305658c9dee7ba18b7c86940c72456cc08137929755fa4e8960b4` |
| SHA256(wire bytes) | `bc801eacf5190eda8ff802b8bc5772715a5754356f50429f9a5564f4ebb0beb8` |
...
| Field | Value |
|---|---|
| `T_setup` | `ec872cf8b211b00e7f74e20c28c3e42b9eba7c5b6cd2f803e426a7318f374873` |
...
| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `a7e304ef3d2705c446d8dc17c25ef802e99037a7a31cac33e3ad562db5c67ee3` |
| signature (final 64 bytes) | `11ec14a14e546cbc6b0967bade75cceeaa036ae8f16281217f28898499920839384a856f3c6bf9e172b65931562cd723003c71ba5c4faa7799aa752c95c548ac` |
| SHA256(wire bytes) | `39f88a6f6754782fec090a6724466633e2060be8642ffe53506c11cfed0fb036` |

Wire bytes:

```

```

| Field | Value |
|---|---|
| `H_act` | `f8d458c23960e3ea427e7ed04501a97a9f9739f35536fa2edab42016c9ce7d94` |

**`ff_activate_ack` (type 55047, 162 bytes, signed by `S`)** (`activation_hash = H_act`)

| Field | Value |
|---|---|
| digest `SHA256("ffor/msg" || type || body)` | `c776f775435e5c44e302f6b4197b09914c93bbcbe0454442069faaeabc76e2fe` |
| signature (final 64 bytes) | `3f55994daf9da64d25f3e2841b99f25103c0fd86d38a7db7a8b337d6775f3509285f738e5e2441825d502c5220562a3ef21d68c41d86de37e417d387b3663b28` |
| SHA256(wire bytes) | `28d1d81ee89333d217a8216b7416b1e0a7cfd2e9ae95b2382ecebd82fa07581a` |

Wire bytes:

```

```
...
238. [D.5] ff_init (19982 bytes) and ff_accept (19510 bytes) fit a BOLT 8 message
...
Places where the spec text left a byte-level choice to the implementer, and
what these vectors assume. None changes the protocol; each is a sentence the
spec could add.

1. **7, signed messages.** `body` in the digest formula is taken to include
   the `[32: channel_id][32: epoch_id]` header (7 defines the header as the
   start of every message and lists it among the "wire bytes"). The digest is
   signed directly (single SHA256; BOLT 7 node signatures use a double SHA256),
   with a 64-byte compact low-S ECDSA signature.
2. **7, TLV stream placement.** The stream has no length prefix; a parser takes
   everything between the last fixed field and the final 64 bytes. TLV types
   and lengths are BigSize (BOLT 1). `ff_activate` and `ff_activate_ack` carry
   an empty stream.
3. **9.5.1, voucher onion.** The associated data is `payment_hash = H_k` as for
   any payment onion; the spec does not say so. "Fresh random ephemeral key" is
   seeded here for reproducibility. The payload TLVs are types 2, 4 and 8 only
   (no `short_channel_id`, no type 18).
4. **7.1, `r_per_commitment_points` in Variant D.** The field carries `K`
   points for `n_R+1 .. n_R+K`, but a Variant D setup builds exactly one
   commitment for `R` (`n_R+1`), whose point `S` already holds from `R`'s last
   `revoke_and_ack`; the remaining `K-1` points are unused. The vectors carry
   all `K` as the table requires (D.5: 483 x 33 = 15,939 bytes of `ff_init`).
5. **7.6, fee-spike buffer.** "Plus both anchors, evaluated at twice the frozen
   feerate" is read as `fee(2 x feerate, K) + 660 sat`: the anchors are a fixed
   330 sat each and do not scale with the feerate.
6. **7.5.2, `H_commit`.** Txids are hashed in internal byte order (the order in
   which they appear inside a transaction), which is the reverse of the display
   order most tools print; both are given for every commitment.
7. **14 versus 17.3.** The registry's closing line still lists Appendix D as
   "taproot variant, TBD" while 17.3 assigns Appendix D to the 9.5.1 transcript
   vectors, which this file is.
8. **7.5.6 versus Appendix A.** `D = 799,000` in Appendix A is 1,000 blocks
   before `T_exp`, under the recommended 1,008-block margin; these vectors use
   `D = 798,992`. `D` does not enter any commitment, so Appendix A is unaffected.
