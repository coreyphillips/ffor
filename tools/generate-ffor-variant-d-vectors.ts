 ...
 *     ../ffor/tools/generate-ffor-variant-d-vectors.ts \
 *     > ../ffor/ffor-variant-d-vectors.md
 *
...
w('  ../ffor/tools/generate-ffor-variant-d-vectors.ts > ../ffor/ffor-variant-d-vectors.md');
w('```');
w();
...
w('---');
w();
w('*Generated by `tools/generate-ffor-variant-d-vectors.ts` against beignet');
